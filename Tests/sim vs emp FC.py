...
for t in temp_ar:
    ...
    axis[0].set_ylim([-84, 84])
    #axis[0].plot(TS.series_deriv(TS.sum_spin_series), color = 'green')
    axis[0].scatter(TS.iterations, TS.sum_spin_series)
    axis[0].plot(TS.iterations, TS.average_series(TS.sum_spin_series), 'r')
